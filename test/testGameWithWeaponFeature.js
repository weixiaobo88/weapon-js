...
describe('Game with career and weapon feature: ', function() {
	...
	describe('two players begin to fight:', function() {
		it('warrior fight with normal, should return attack info and damage info: ', function() {
		...
		it('normal fight with warrior, should return attack info and damage info: ', function() {
